...
NDiplomacy = {
	...
	RELEASE_FROM_PRISON_INTERACTION_ENABLED = 0, -- was 1			-- Should this action be used at all?
	...
	RANSOM_CHARACTER_INTERACTION_ENABLED = 0, -- was 1				-- Should this action be used at all?
	...
	ASK_TO_RANSOM_CHARACTER_INTERACTION_ENABLED = 0, -- was 1			-- Should this action be used at all?		
